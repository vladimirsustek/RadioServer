...
int Ringbuf_init() {return 0;}

int Uart_sendstring(char *p) {return 0;}
int Wait_for(char *p) {return 0;}
int Uart_flush() {return 0;}

int Get_after(char *p, ...) {return 0;}
int Copy_upto(char *p, ...) {return 0;}
int Look_for(char *p, ...) {return 0;}
int GetDataFromBuffer(char *p, ...) {return 0;}
